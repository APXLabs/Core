...
#pragma warning restore 219
		...
		public void ProxyForNonPublicClass()
		{
			...
			// DynamicProxy2
			var type = Type.GetType("System.__ComObject, mscorlib");
			var exception = Assert.Throws<GeneratorException>(() => generator.CreateClassProxy(type, new StandardInterceptor()));
			Assert.AreEqual(
				"Can not create proxy for type System.__ComObject because it is not accessible. Make it public, or internal and mark your assembly with [assembly: InternalsVisibleTo(\"DynamicProxyGenAssembly2, PublicKey=\")] attribute, because assembly mscorlib is strong-named.",
				exception.Message);
		}
